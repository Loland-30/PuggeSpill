...
function EnemyStage({
    ...
    return (
        <section className="relative mx-auto flex min-h-[22rem] w-full max-w-7xl flex-1 items-end justify-center px-0 pb-20 pt-14 min-[400px]:min-h-[25rem] sm:min-h-[34rem] sm:px-4 sm:pb-24 sm:pt-16 md:min-h-[38rem] lg:min-h-[42rem] landscape:max-sm:min-h-[15rem] landscape:max-sm:pb-16 landscape:max-sm:pt-8">
            <div className="grid w-full grid-cols-[minmax(0,1fr)_minmax(1rem,0.18fr)_minmax(0,1fr)] items-end gap-1 sm:grid-cols-[minmax(8rem,0.9fr)_minmax(3rem,0.45fr)_minmax(8rem,0.9fr)] sm:gap-4 md:gap-8 lg:gap-16">
                ...
                <div className="relative flex min-w-0 justify-center md:justify-start">
                    <div className="absolute -top-12 left-1/2 z-10 w-[min(10rem,42vw)] -translate-x-1/2 text-white sm:-top-16 sm:w-72 md:left-10 md:translate-x-0 lg:-top-20">
                        <div className="flex items-end justify-between gap-2 text-xs font-black drop-shadow-[0_2px_8px_rgba(0,0,0,0.75)] sm:gap-3 sm:text-2xl">
                    ...
                    <div className="relative scale-x-[-1]">
                        <img
                            ...
                            src={enemyImageUrl}
                            alt={enemy.name}
                            className={`h-[11rem] max-w-full object-contain drop-shadow-[0_20px_28px_rgba(0,0,0,0.45)] transition duration-300 min-[400px]:h-[14rem] sm:h-[25rem] lg:h-[28rem] landscape:max-sm:h-[9rem] ${
